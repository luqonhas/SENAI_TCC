...
namespace Avanade.Shared.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendAlertEmail(string emailUser, int amountOfPeople)
        {
            ...
            string FilePath = CurrentFilePath.Replace("Avanade.Api", "Avanade.Shared\\Templates\\");
            ...
            if (amountOfPeople <= 3)
            {
                ...
                // put a subject
                email.Subject = "Alerta na área de risco - Seguro";
            ...
            if (amountOfPeople > 3 && amountOfPeople <= 7)
            {
                ...
                email.To.Add(MailboxAddress.Parse(request.ToEmail));
                // put a subject
                email.Subject = "Alerta na área de risco - Cuidado";
            ...
            if (amountOfPeople > 7)
            {
                ...
                email.To.Add(MailboxAddress.Parse(request.ToEmail));
                // put a subject
                email.Subject = "Alerta na área de risco - Perigo";
